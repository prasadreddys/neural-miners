...
router.get('/ai/missions', async (req, res) => {
  ...
  // stub: connect to AI service
  const missions = [
    { id: 'm1', title: 'Crack the synth node', reward: 150, difficulty: 'medium' },
    { id: 'm2', title: 'Secure a rogue AI packet', reward: 120, difficulty: 'easy' },
    { id: 'm3', title: 'Hijack a corporate energy hub', reward: 300, difficulty: 'hard' }
  ];
  res.json({ missions, updatedAt: Date.now() });
});
